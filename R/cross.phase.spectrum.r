#' Compute the phase spectrum of two timeseries.
#'
...
#'
#' @examples
#' #cross.phase.spectrum(1:10, sin(1:10), 1:10, cos(1:10), 2*pi/1:10, FALSE)
cross.phase.spectrum <- function(t1, x1, t2, x2, omega,
                                 demeaned = FALSE) {
    ...
    atan2(-quad.spectrum, co.spectrum) %% 2*pi
