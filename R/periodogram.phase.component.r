#' Compute one component of the phase periodogram.
#'
...
#'
#' @examples
#' periodogram.phase.component(1:10, sin(1:10), 1, tau(1:10, 1), "sin")
#'
#' @export
periodogram.phase.component <- function(t, x, omega, tau, sincos) {
    ...
    (sincos.vec %*% x) / rowSums(sincos.vec^2)
